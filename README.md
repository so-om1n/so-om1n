# 현수민 · Frontend Developer

프레임워크 뒤에서 무엇이 일어나는지 궁금해서 WebSocket 프로토콜을 직접 구현해봤습니다.
성능과 사용성을 함께 고려하는 프론트엔드 개발자를 지향합니다.

- 🎓 단국대학교 컴퓨터공학 (2026.08 졸업예정)
- 🔐 구름 정보보호 개발자 양성과정 17기 수료 — 공격자 관점에서 안전한 프론트엔드
- 🏆 2026 관광데이터 활용 공모전 웹·앱 개발 부문 장려상
...
![Node.js](https://img.shields.io/badge/Node.js-black?style=flat&logo=nodedotjs&logoColor=339933)
![Tailwind CSS](https://img.shields.io/badge/Tailwind%20CSS-black?style=flat&logo=tailwindcss&logoColor=06B6D4)

### State & Data
![Zustand](https://img.shields.io/badge/Zustand-black?style=flat&logo=react&logoColor=white)
![TanStack Query](https://img.shields.io/badge/TanStack%20Query-black?style=flat&logo=reactquery&logoColor=FF4154)
![WebSocket](https://img.shields.io/badge/WebSocket-black?style=flat&logo=socketdotio&logoColor=white)
...
### Security
![OWASP ZAP](https://img.shields.io/badge/OWASP%20ZAP-black?style=flat&logo=owasp&logoColor=white)
![Burp Suite](https://img.shields.io/badge/Burp%20Suite-black?style=flat&logo=burpsuite&logoColor=FF6633)
